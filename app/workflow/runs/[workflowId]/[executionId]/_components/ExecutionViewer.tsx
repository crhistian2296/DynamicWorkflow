          ...
          <ExecutionLabel
            ...
            value={
              <div className="flex items-center gap-2">
                <PhaseStatusBadge
                  status={executionData?.status as ExecutionPhaseStatus}
                />
                <span>{executionData?.status}</span>
              </div>
            }
          />
          {/* Started at label */}
        ...
        {!isRunning && selectedPhase && data && (
          <div className="flex flex-col py-4 container gap-4 overflow-auto">
            <div className="flex gap-2 items-center">
              <Badge variant={"outline"} className="space-x-4">
                <div className="flex gap-1 items-center">
                  ...
                  <span>Credits</span>
                  <span>{data.creditsConsumed}</span>
                </div>
              </Badge>
              <Badge variant={"outline"} className="space-x-4">
                <div className="flex gap-1 items-center">
                  ...
                  <span>Durations</span>
                  <span>
                    {DatesToDurationString(data.startedAt, data.completedAt) ||
                      "-"}
                  </span>
                </div>
              </Badge>
            ...
            <ParameterViewer
              ...
              paramsJson={data.inputs}
            />
            <ParameterViewer
              title="Outputs"
              subtitle="Outputs generated by this phase"
              paramsJson={data.outputs}
            />
