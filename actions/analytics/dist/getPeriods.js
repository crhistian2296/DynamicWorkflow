...
var GetPeriods = function () { return __awaiter(void 0, void 0, void 0, function () {
    var userId, years, currentDate, currentYear, currentMonth, minYear, periods, year, month;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, prisma_1["default"].workflowExecution.aggregate({
                        where: { userId: userId },
                        _min: { startedAt: true }
                    })];
            case 2:
